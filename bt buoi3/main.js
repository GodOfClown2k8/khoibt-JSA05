...
// 1.các tham số truyền vào phương thức trên có nghĩa là : 
// 2 : vị trí bắt đầu thay 
// 1 : số phần tử cần thay 
// 7 : phần tử thay vào 1
// 8 : phần tử thay vào 2 
// Sau khi log sẽ ra kết qua myArray = [4, 5, 7, 8, 8, 9, 1] 
// vì : lệnh đã yêu cầu thay từ vị trí thứ 2 trong hàm tính từ 0 (tức là số 7)
// và thay 1 phần tử tính từ số 7 thì ngừng lại , 2 phần tử được thay vào là số 7 và 8 thì ngừng lại và viết lại các phần tử còn lại.
